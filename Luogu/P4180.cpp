...
#define int ll
const int z=1e5+5,inf=2147483647000000;
int in[z],n,m,out[z],lca[z][19],dfn=0,mx[z][19],sec[z][19],pa[z],sum=0;
vector<pll> v[z];
struct  qq{
    int a,b,c;
...
main(){Rosario
    ...
    REP(i,m) if(!vis[i]){
        ...
        int ss=max(que(q[i].a,x,q[i].c),que(q[i].b,x,q[i].c));
